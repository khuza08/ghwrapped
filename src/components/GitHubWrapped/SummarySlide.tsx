...
const SummarySlide: React.FC<WrappedSlideProps> = ({ data }) => {
  ...
  return (
    <div className="w-full max-w-md mx-auto text-center">
      ...
      >
        <h3 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">GitHub Wrapped 2024</h3>
        <div className="flex items-center justify-center mb-4 sm:mb-6">
          ...
          <div className="text-left">
            <h4 className="text-lg sm:text-xl font-semibold text-gray-800">{user.name || user.login}</h4>
            <p className="text-sm sm:text-base text-gray-600">@{user.login}</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <div className="text-xs sm:text-sm text-gray-600">Commits</div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <div className="text-xs sm:text-sm text-gray-600">On GitHub</div>
        </motion.div>
      </motion.div>
