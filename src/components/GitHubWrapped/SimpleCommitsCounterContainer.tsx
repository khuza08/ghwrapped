...
interface SimpleCommitsCounterContainerProps {
  username: string;
  onBackClick?: () => void;
}

const SimpleCommitsCounterContainer: React.FC<SimpleCommitsCounterContainerProps> = ({
  username,
  onBackClick
}) => {
  ...
  return (
    <div className="relative flex flex-col w-full h-screen bg-[#0a0a0a]">
      <div className="flex-1 overflow-hidden relative">
        <div className="w-screen h-full overflow-hidden relative py-6">
          {/* Header */}
...
export default SimpleCommitsCounterContainer;
